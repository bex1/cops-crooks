...
public class GameModelTest {
	...
	public void testConstructor() {
		...
		try{
			GameModel gameModel = new GameModel(null, null, null, null, null, null);
			fail();
	...
	public void testNextPlayer(){
		...
		GameModel gameModel = new GameModel(mediator, players.get(0), players, tiles, new ArrayList<TramLine>(), null);
